...
<b>４．Windows Admin Center (※プレビュー)</b> [参考](https://learn.microsoft.com/ja-jp/windows-server/manage/windows-admin-center/use/vm-conversion-extension-overview)
　Windows Admin Center の VM Conversion 拡張機能を使用して、VMware 仮想マシンを Hyper-V 仮想マシンへ変換するためのツールです。ブラウザー ベースの管理画面から変換操作を実施でき、現在はプレビューとして提供されています。
